...
--L.EnableArrows_Desc2 = "As of Patch 5.4, a Blizzard bug has broken the ability to use the Up/Down arrows to cycle through your chat input history without holding the Alt key. This option includes a workaround for the bug, but it doesn't work for secure slash commands like /cast or /use. You can still use Alt+Up/Down to cycle through your complete input history, including secure slash commands, while regular Up/Down will only cycle through \"safe\" commands."
